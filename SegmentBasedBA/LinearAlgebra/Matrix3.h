...
namespace LA
{
	...
	public:
		...
		inline const  ENFT_SSE::__m128& M_20_21_22_x() const { return m_20_21_22_x; }				inline  ENFT_SSE::__m128& M_20_21_22_x() { return m_20_21_22_x; }
		inline const float& M20()	   const { return m_20_21_22_x.m128_f32[0]; }		inline float& M20()		 { return m_20_21_22_x.m128_f32[0]; }
		inline const float& M21()	   const { return m_20_21_22_x.m128_f32[1]; }		inline float& M21()		 { return m_20_21_22_x.m128_f32[1]; }
		inline const float& M22()	   const { return m_20_21_22_x.m128_f32[2]; }		inline float& M22()		 { return m_20_21_22_x.m128_f32[2]; }
		inline const float& reserve2() const { return m_20_21_22_x.m128_f32[3]; }		inline float& reserve2() { return m_20_21_22_x.m128_f32[3]; }
		...
		inline void Set(const float *M) { memcpy(&M00(), M, 12); memcpy(&M10(), M + 3, 12); memcpy(&M20(), M + 6, 12); }
		inline void Get(float *M) const { memcpy(M, &M00(), 12); memcpy(M + 3, &M10(), 12); memcpy(M + 6, &M20(), 12); }
		...
		inline void SetReserveZero() { reserve0() = reserve1() = reserve2() = 0; }
		inline void SetReserve2() { reserve0() = M02(); reserve1() = M12(); reserve2() = M22(); }
#if _DEBUG
		inline void AssertReserve2() const { assert(reserve0() == M02() && reserve1() == M12() && reserve2() == M22()); }
#endif
		inline void MakeIdentity() { memset(this, 0, 48); M00() = M11() = M22() = 1; }
		inline void SetZero() { memset(this, 0, 48); }
		...
		{
			AT.M00() = M00();	AT.M01() = M10();	AT.M02() = M20();
			AT.M10() = M01();	AT.M11() = M11();	AT.M12() = M21();
			AT.M20() = M02();	AT.M21() = M12();	AT.M22() = M22();
		}
		...
		inline float FrobeniusNorm() const
		{
			return sqrt(ENFT_SSE::SSE::Sum012( ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps(m_00_01_02_x, m_00_01_02_x),
									 ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps(m_10_11_12_x, m_10_11_12_x),  ENFT_SSE::_mm_mul_ps(m_20_21_22_x, m_20_21_22_x)))));
		}
		inline void EnforceUnitFrobeniusNorm() { Scale( ENFT_SSE::_mm_set1_ps(1 / FrobeniusNorm())); }
		inline void EnforceUnitLastEntry() { Scale( ENFT_SSE::_mm_set1_ps(1 / M22())); }
		...
		{
			M00() = 0;			M01() = -v.v2();	M02() = v.v1();
			M10() = v.v2();		M11() = 0;			M12() = -v.v0();
			M20() = -v.v1();	M21() = v.v0();		M22() = 0;
		}
		...
		inline void SaveB(FILE *fp) const { fwrite(this, sizeof(AlignedMatrix3f), 1, fp); }
		inline void LoadB(FILE *fp) { fread(this, sizeof(AlignedMatrix3f), 1, fp); }
		...
		inline void GetDiagonal(AlignedVector3f &d) const { d.v0() = M00(); d.v1() = M11(); d.v2() = M22(); }
		inline void SetDiagonal(const AlignedVector3f &d) { M00() = d.v0(); M11() = d.v1(); M22() = d.v2(); }
		inline void ScaleDiagonal(const float &lambda) { M00() *= lambda; M11() *= lambda; M22() *= lambda; }
		inline void IncreaseDiagonal(const float &lambda) { M00() += lambda; M11() += lambda; M22() += lambda; }
		...
		inline void ScaleRow2(const float &s) {	M_20_21_22_x() =  ENFT_SSE::_mm_mul_ps(M_20_21_22_x(),  ENFT_SSE::_mm_set1_ps(s)); }
		inline void ScaleColumn2(const float &s) { M02() *= s; M12() *= s; M22() *= s; }
	...
	{
		work =  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps(A.M_00_01_02_x(), A.M_00_01_02_x()),  ENFT_SSE::_mm_mul_ps(A.M_10_11_12_x(), A.M_10_11_12_x())), 
	...
	{
		to.v012x() =  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps(A.M_00_01_02_x(), A.M_00_01_02_x()),  ENFT_SSE::_mm_mul_ps(A.M_10_11_12_x(), A.M_10_11_12_x())), 
								 ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps(A.M_20_21_22_x(), A.M_20_21_22_x()), to.v012x()));
	}
	template<> inline void FinishAdditionAij2To<AlignedMatrix3f>(AlignedVector3f &to) { to.reserve() = to.v2(); }

	inline void AddATBTo(const AlignedMatrix3f &A, const  ENFT_SSE::__m128 &B, Vector3f &to,  ENFT_SSE::__m128 &work)
	{
		work =  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps(A.M_00_01_02_x(),  ENFT_SSE::_mm_set1_ps(B.m128_f32[0])),  ENFT_SSE::_mm_mul_ps(A.M_10_11_12_x(),  ENFT_SSE::_mm_set1_ps(B.m128_f32[1]))), 
									  ENFT_SSE::_mm_mul_ps(A.M_20_21_22_x(),  ENFT_SSE::_mm_set1_ps(B.m128_f32[2])));
		to.v0() = work.m128_f32[0] + to.v0();
		to.v1() = work.m128_f32[1] + to.v1();
		to.v2() = work.m128_f32[2] + to.v2();
	}
	inline void AddATBTo(const AlignedMatrix3f &A, const AlignedVector3f &B, Vector3f &to,  ENFT_SSE::__m128 &work)
	{
		work =  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps(A.M_00_01_02_x(),  ENFT_SSE::_mm_set1_ps(B.v0())),  ENFT_SSE::_mm_mul_ps(A.M_10_11_12_x(),  ENFT_SSE::_mm_set1_ps(B.v1()))), 
			 ENFT_SSE::_mm_mul_ps(A.M_20_21_22_x(),  ENFT_SSE::_mm_set1_ps(B.v2())));
		to.v0() = work.m128_f32[0] + to.v0();
		to.v1() = work.m128_f32[1] + to.v1();
		to.v2() = work.m128_f32[2] + to.v2();
	}
	inline void AddATBTo(const AlignedMatrix3f &A, const Vector3f &B, AlignedVector3f &to)
	{
		to.v012x() =  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps(A.M_00_01_02_x(),  ENFT_SSE::_mm_set1_ps(B.v0())),  ENFT_SSE::_mm_mul_ps(A.M_10_11_12_x(),  ENFT_SSE::_mm_set1_ps(B.v1()))), 
								 ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps(A.M_20_21_22_x(),  ENFT_SSE::_mm_set1_ps(B.v2())), to.v012x()));
	}
	inline void AddATBTo(const AlignedMatrix3f &A, const AlignedVector3f &B, AlignedVector3f &to)
	{
		to.v012x() =  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps(A.M_00_01_02_x(),  ENFT_SSE::_mm_set1_ps(B.v0())),  ENFT_SSE::_mm_mul_ps(A.M_10_11_12_x(),  ENFT_SSE::_mm_set1_ps(B.v1()))), 
								 ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps(A.M_20_21_22_x(),  ENFT_SSE::_mm_set1_ps(B.v2())), to.v012x()));
	}
	...
	{
		to.M_00_01_02_x() =  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(A.M00()), A.M_00_01_02_x()), 
...
//		to.M12() = A.M01() * A.M02() + A.M11() * A.M12() + A.M21() * A.M22() + to.M12();
		to.M_00_01_02_x() =  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(A.M00()), A.M_00_01_02_x()),  ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(A.M10()), A.M_10_11_12_x())), 
									    ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(A.M20()), A.M_20_21_22_x()), to.M_00_01_02_x()));
		to.M11() = A.M01() * A.M01() + A.M11() * A.M11() + A.M21() * A.M21() + to.M11();
		to.M12() = A.M01() * A.M02() + A.M11() * A.M12() + A.M21() * A.M22() + to.M12();
		to.M22() = A.M02() * A.M02() + A.M12() * A.M12() + A.M22() * A.M22() + to.M22();
	}
	template<class MATRIX> inline void FinishAdditionATAToUpper(AlignedMatrix3f &to) {}
	...
	inline void GetDiagonal(const AlignedMatrix3f &M, AlignedVector3f &d) { M.GetDiagonal(d); }
	inline void SetDiagonal(const AlignedVector3f &d, AlignedMatrix3f &M) { M.SetDiagonal(d); }
	inline void ScaleDiagonal(const float &lambda, AlignedMatrix3f &M) { M.ScaleDiagonal(lambda); }
	inline void IncreaseDiagonal(const float &lambda, AlignedMatrix3f &M) { M.IncreaseDiagonal(lambda); }

	inline void AB(const AlignedMatrix3f &A, const AlignedVector3f &B, AlignedVector3f &AB)
	{
	...
	inline void ABx(const AlignedMatrix3f &A, const AlignedVector3f &B, float &ABx00, float &ABx01, float &ABx02, float &ABx10, float &ABx11, float &ABx12, 
					float &ABx20, float &ABx21, float &ABx22)
	{
		ABx00 = A.M01() * B.v2() - A.M02() * B.v1();	ABx01 = A.M02() * B.v0() - A.M00() * B.v2();	ABx02 = A.M00() * B.v1() - A.M01() * B.v0();
		ABx10 = A.M11() * B.v2() - A.M12() * B.v1();	ABx11 = A.M12() * B.v0() - A.M10() * B.v2();	ABx12 = A.M10() * B.v1() - A.M11() * B.v0();
		ABx20 = A.M21() * B.v2() - A.M22() * B.v1();	ABx21 = A.M22() * B.v0() - A.M20() * B.v2();	ABx22 = A.M20() * B.v1() - A.M21() * B.v0();
	}
	inline void ATB(const AlignedMatrix3f &A, const AlignedVector3f &B, AlignedVector3f &ATB)
	{
		ATB.v012x() =  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps(A.M_00_01_02_x(),  ENFT_SSE::_mm_set1_ps(B.v0())), 
					   ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps(A.M_10_11_12_x(),  ENFT_SSE::_mm_set1_ps(B.v1())),  ENFT_SSE::_mm_mul_ps(A.M_20_21_22_x(),  ENFT_SSE::_mm_set1_ps(B.v2()))));
	}
	inline void AB(const AlignedMatrix3f &A, const AlignedMatrix3f &B, AlignedMatrix3f &AB,  ENFT_SSE::__m128 &work)
	{
	...
	inline void AB(const AlignedMatrix3f &A, const AlignedMatrix3f &B, AlignedMatrix3f &AB,  ENFT_SSE::__m128 *work3)
	{
	...
	inline void AB(const AlignedMatrix2x3f &A, const AlignedMatrix3f &B, AlignedMatrix2x3f &AB,  ENFT_SSE::__m128 &work)
	{
		work =  ENFT_SSE::_mm_setr_ps(B.M00(), B.M10(), B.M20(), 0);
		AB.M00() = ENFT_SSE::SSE::Sum012( ENFT_SSE::_mm_mul_ps(A.M_00_01_02_x(), work));
		AB.M10() = ENFT_SSE::SSE::Sum012( ENFT_SSE::_mm_mul_ps(A.M_10_11_12_x(), work));
	...
	inline void ATB(const AlignedMatrix3f &A, const AlignedMatrix3f &B, AlignedMatrix3f &ATB)
	{
		ATB.M_00_01_02_x() =  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(A.M00()), B.M_00_01_02_x()), 
							  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(A.M10()), B.M_10_11_12_x()),  ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(A.M20()), B.M_20_21_22_x())));
		ATB.M_10_11_12_x() =  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(A.M01()), B.M_00_01_02_x()), 
							  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(A.M11()), B.M_10_11_12_x()),  ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(A.M21()), B.M_20_21_22_x())));
		ATB.M_20_21_22_x() =  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(A.M02()), B.M_00_01_02_x()), 
							  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(A.M12()), B.M_10_11_12_x()),  ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(A.M22()), B.M_20_21_22_x())));
	}
	// A and ATB are allowed to be the same
	inline void ABT(const AlignedMatrix3f &A, const AlignedMatrix3f &B, AlignedMatrix3f &ABT)
	{
		ENFT_SSE::SSE::Set012(ENFT_SSE::SSE::Sum012( ENFT_SSE::_mm_mul_ps(A.M_00_01_02_x(), B.M_00_01_02_x())), 
					...
					ENFT_SSE::SSE::Sum012( ENFT_SSE::_mm_mul_ps(A.M_00_01_02_x(), B.M_20_21_22_x())), ABT.M_00_01_02_x());
		ENFT_SSE::SSE::Set012(ENFT_SSE::SSE::Sum012( ENFT_SSE::_mm_mul_ps(A.M_10_11_12_x(), B.M_00_01_02_x())), 
					...
					ENFT_SSE::SSE::Sum012( ENFT_SSE::_mm_mul_ps(A.M_10_11_12_x(), B.M_20_21_22_x())), ABT.M_10_11_12_x());
		ENFT_SSE::SSE::Set012(ENFT_SSE::SSE::Sum012( ENFT_SSE::_mm_mul_ps(A.M_20_21_22_x(), B.M_00_01_02_x())), 
					...
					ENFT_SSE::SSE::Sum012( ENFT_SSE::_mm_mul_ps(A.M_20_21_22_x(), B.M_20_21_22_x())), ABT.M_20_21_22_x());
	}
	inline void ABT(const AlignedVector3f &A, const AlignedVector3f &B, AlignedMatrix3f &ABT)
	{
	...
	inline void AB_T(const AlignedMatrix3f &A, const AlignedMatrix3f &B, AlignedMatrix3f &AB_T,  ENFT_SSE::__m128 &work)
	{
	...
	inline void ABpC(const AlignedMatrix3f &A, const AlignedVector3f &B, const AlignedVector3f &C, AlignedVector3f &ABpC)
	{
	...
	inline void nABpC(const AlignedMatrix3f &A, const AlignedVector3f &B, const AlignedVector3f &C, AlignedVector3f &nABpC)
	{
	...
	{
		A.M_00_01_02_x() =  ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(s.v0()), s.v012x()), A.M_00_01_02_x());
		A.M_10_11_12_x() =  ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(s.v1()), s.v012x()), A.M_10_11_12_x());
		A.M_20_21_22_x() =  ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(s.v2()), s.v012x()), A.M_20_21_22_x());
	}
	bool InvertSymmetricUpper(AlignedMatrix3f &A);
	bool InvertSymmetricUpper(const AlignedMatrix3f &A, AlignedMatrix3f &Ainv);
	inline bool InvertSymmetricUpper(const AlignedMatrix3f &A, AlignedMatrix3f &Ainv, float *work0) { return InvertSymmetricUpper(A, Ainv); }
	bool SolveLinearSystemSymmetricUpper(AlignedMatrix3f &A, AlignedVector3f &b);
	inline bool SolveLinearSystemSymmetricUpper(AlignedMatrix3f &A, AlignedVector3f &b, float *work0) { return SolveLinearSystemSymmetricUpper(A, b); }
	...
	public:
		...
		{
			MT.M00() = M00();	MT.M10() = M01();	MT.M20() = M02();
			MT.M01() = M10();	MT.M11() = M11();	MT.M21() = M12();
			MT.M02() = M20();	MT.M12() = M21();	MT.M22() = M22();
		}
		inline void operator += (const Matrix3<TYPE> &M)
		{
			M00() = M.M00() + M00();	M01() = M.M01() + M01();	M02() = M.M02() + M02();
			M10() = M.M10() + M10();	M11() = M.M11() + M11();	M12() = M.M12() + M12();
			M20() = M.M20() + M20();	M21() = M.M21() + M21();	M22() = M.M22() + M22();
		}
		inline void operator -= (const Matrix3<TYPE> &M)
		{
			M00() = -M.M00() + M00();	M01() = -M.M01() + M01();	M02() = -M.M02() + M02();
	...
	template<class TYPE> inline void AmB(const Matrix3<TYPE> &A, const Matrix3<TYPE> &B, Matrix3<TYPE> &AmB)
	{
		AmB.M00() = A.M00() - B.M00();		AmB.M01() = A.M01() - B.M01();		AmB.M02() = A.M02() - B.M02();
		AmB.M10() = A.M10() - B.M10();		AmB.M11() = A.M11() - B.M11();		AmB.M12() = A.M12() - B.M12();
		AmB.M20() = A.M20() - B.M20();		AmB.M21() = A.M21() - B.M21();		AmB.M22() = A.M22() - B.M22();
	}
	template<class TYPE> inline void AddAij2To(const Matrix3<TYPE> &A, Vector3<TYPE> &to)
	{
	...
	template<typename TYPE> inline void sA(const Vector3<TYPE> &s, Matrix3<TYPE> &A)
	{
		A.M00() *= s.v0();	A.M01() *= s.v1();	A.M02() *= s.v2();
		A.M10() *= s.v0();	A.M11() *= s.v1();	A.M12() *= s.v2();
		A.M20() *= s.v0();	A.M21() *= s.v1();	A.M22() *= s.v2();
	}
	template<typename TYPE> inline void AddsATo(const TYPE &s, const Matrix3<TYPE> &A, Matrix3<TYPE> &to)
	{
		to.M00() = s * A.M00() + to.M00();		to.M01() = s * A.M01() + to.M01();		to.M02() = s * A.M02() + to.M02();
		to.M10() = s * A.M10() + to.M10();		to.M11() = s * A.M11() + to.M11();		to.M12() = s * A.M12() + to.M12();
		to.M20() = s * A.M20() + to.M20();		to.M21() = s * A.M21() + to.M21();		to.M22() = s * A.M22() + to.M22();
	}
	template<typename TYPE> inline void AddsATTo(const TYPE &s, const Matrix3<TYPE> &A, Matrix3<TYPE> &to)
	{
		to.M00() = s * A.M00() + to.M00();		to.M01() = s * A.M10() + to.M01();		to.M02() = s * A.M20() + to.M02();
		to.M10() = s * A.M01() + to.M10();		to.M11() = s * A.M11() + to.M11();		to.M12() = s * A.M21() + to.M12();
		to.M20() = s * A.M02() + to.M20();		to.M21() = s * A.M12() + to.M21();		to.M22() = s * A.M22() + to.M22();
	}
	template<class TYPE> inline void AddABTo(const Matrix3<TYPE> &A, const Vector3<TYPE> &B, Vector3<TYPE> &to)
	{
	...
	template<class TYPE> inline void AddABTo(const Matrix3<TYPE> &A, const Matrix3<TYPE> &B, Matrix3<TYPE> &to)
	{
	...
	template<class TYPE> inline void AddABTTo(const Matrix3<TYPE> &A, const Matrix3<TYPE> &B, Matrix3<TYPE> &to)
	{
	...
	template<class TYPE> inline void AddATBTo(const Matrix3<TYPE> &A, const AlignedVector3f &B, Vector3<TYPE> &to)
	{
	...
	inline void AddATBTo(const AlignedMatrix2x3f &A, AlignedMatrix2x3f &B, Matrix3f &to,  ENFT_SSE::__m128 &work)
	{
		work =  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(A.M00()), B.M_00_01_02_x()),  ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(A.M10()), B.M_10_11_12_x()));
		to.M00() = work.m128_f32[0] + to.M00();
		to.M01() = work.m128_f32[1] + to.M01();
		to.M02() = work.m128_f32[2] + to.M02();

		work =  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(A.M01()), B.M_00_01_02_x()),  ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(A.M11()), B.M_10_11_12_x()));
		to.M10() = work.m128_f32[0] + to.M10();
		to.M11() = work.m128_f32[1] + to.M11();
		to.M12() = work.m128_f32[2] + to.M12();

		work =  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(A.M02()), B.M_00_01_02_x()),  ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(A.M12()), B.M_10_11_12_x()));
		to.M20() = work.m128_f32[0] + to.M20();
		to.M21() = work.m128_f32[1] + to.M21();
		to.M22() = work.m128_f32[2] + to.M22();
	}
	template<class MATRIX_A, class MATRIX_B> inline void FinishAdditionATBTo(Matrix3f &to) {}
	template<typename TYPE> inline bool Invert(const Matrix3<TYPE> &M, Matrix3f &Minv)
	{
		...
		const float det = M.M00() * Minv.M00() + M.M01() * Minv.M10() + M.M02() * Minv.M20();
		if(fabs(det) < FLT_EPSILON)
			return false;
		Minv.Scale(1 / det);
		return true;
	...
	template<typename TYPE> inline void sA(const TYPE &s, const Matrix3<TYPE> &A, Matrix3<TYPE> &sA)
	{
		sA.M00() = s * A.M00();		sA.M01() = s * A.M01();		sA.M02() = s * A.M02();
		sA.M10() = s * A.M10();		sA.M11() = s * A.M11();		sA.M12() = s * A.M12();
		sA.M20() = s * A.M20();		sA.M21() = s * A.M21();		sA.M22() = s * A.M22();
	}
	template<typename TYPE> inline void AB(const Matrix3<TYPE> &A, const Vector3<TYPE> &B, Vector3<TYPE> &AB)
	{
		AB.v0() = A.M00() * B.v0() + A.M01() * B.v1() + A.M02() * B.v2();
		AB.v1() = A.M10() * B.v0() + A.M11() * B.v1() + A.M12() * B.v2();
		AB.v2() = A.M20() * B.v0() + A.M21() * B.v1() + A.M22() * B.v2();
	}
	template<typename TYPE> inline void AB(const Matrix3<TYPE> &A, const Vector3<TYPE> &B, AlignedVector3f &AB)
	{
	...
	template<typename TYPE> inline void SubtractABFrom(const Matrix3<TYPE> &A, const Vector3<TYPE> &B, Vector3<TYPE> &from)
	{
		from.v0() -= A.M00() * B.v0() + A.M01() * B.v1() + A.M02() * B.v2();
		from.v1() -= A.M10() * B.v0() + A.M11() * B.v1() + A.M12() * B.v2();
		from.v2() -= A.M20() * B.v0() + A.M21() * B.v1() + A.M22() * B.v2();
	}
	template<typename TYPE> inline void SubtractATBFrom(const Matrix3<TYPE> &A, const Vector3<TYPE> &B, Vector3<TYPE> &from)
	{
		from.v0() -= A.M00() * B.v0() + A.M10() * B.v1() + A.M20() * B.v2();
		from.v1() -= A.M01() * B.v0() + A.M11() * B.v1() + A.M21() * B.v2();
		from.v2() -= A.M02() * B.v0() + A.M12() * B.v1() + A.M22() * B.v2();
	}
	template<typename TYPE> inline void s1s2TA(const Vector3<TYPE> &s1, const Vector3<TYPE> &s2, Matrix3<TYPE> &A)
	{
		A.M00() *= s1.v0() * s2.v0();
		A.M01() *= s1.v0() * s2.v1();
		A.M02() *= s1.v0() * s2.v2();
	...
	public:
		...
		inline void SetZero() { memset(this, 0, sizeof(SymmetricMatrix3<TYPE>)); }
		...
		inline void GetDiagonal(Vector3<TYPE> &d) const { d.v0() = m_data[0]; d.v1() = m_data[3]; d.v2() = m_data[5]; }
		inline void SetDiagonal(const Vector3<TYPE> &d) { m_data[0] = d.v0(); m_data[3] = d.v1(); m_data[5] = d.v2(); }
		inline void ScaleDiagonal(const float &lambda) { M00() *= lambda; M11() *= lambda; M22() *= lambda; }
		inline void IncreaseDiagonal(const float &lambda) { M00() += lambda; M11() += lambda; M22() += lambda; }
		//inline float Determinant() const { return M00() * M00() + M01() * M10() + M02() * M20(); }
		inline float Determinant() const { return (M00()*M11() - M01()*M01())*M22() + 2*M01()*M12()*M02() - M02()*M02()*M11() - M12()*M12()*M00(); }
	...
	inline void sA(const float &s, const SymmetricMatrix3f &A, AlignedMatrix3f &sA)
	{
		sA.M00() = s * A.M00();
	...
	template<typename TYPE> inline void AddAATTo(const Matrix3<TYPE> &A, SymmetricMatrix3<TYPE> &to)
	{
	...
	template<class TYPE> inline void AddABTo(const Matrix3<TYPE> &A, const SymmetricMatrix3<TYPE> &B, Matrix3<TYPE> &to)
	{
		to.M00() = A.M00() * B.M00() + A.M01() * B.M10() + A.M02() * B.M20() + to.M00();
		to.M01() = A.M00() * B.M01() + A.M01() * B.M11() + A.M02() * B.M21() + to.M01();
		to.M02() = A.M00() * B.M02() + A.M01() * B.M12() + A.M02() * B.M22() + to.M02();
	...
	template<class TYPE> inline void AddABTToUpper(const Matrix3<TYPE> &A, const Matrix3<TYPE> &B, SymmetricMatrix3<TYPE> &to)
	{
//#if _DEBUG
...
//#endif
	...
	template<typename TYPE> inline void AddsATo(const TYPE &s, const SymmetricMatrix3<TYPE> &A, Matrix3<TYPE> &to)
	{
		double tmp;
	...
	template<typename TYPE> inline void AddsAToUpper(const TYPE &s, const Matrix3<TYPE> &A, SymmetricMatrix3<TYPE> &to)
	{
		to.M00() = s * A.M00() + to.M00();
	...
	template<typename TYPE> inline void AddATAToUpper(const Matrix2x3<TYPE> &A, SymmetricMatrix3<TYPE> &to)
	{
	...
	inline void AddAATToUpper(const AlignedVector3f &A, SymmetricMatrix3f &to,  ENFT_SSE::__m128 &work)
	{
	...
	inline void AddATAToUpper(const AlignedMatrix2x3f &A, SymmetricMatrix3f &to,  ENFT_SSE::__m128 &work)
	{
		work =  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(A.M00()), A.M_00_01_02_x()),  ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(A.M10()), A.M_10_11_12_x()));
		to.M00() = work.m128_f32[0] + to.M00();
		to.M01() = work.m128_f32[1] + to.M01();
		to.M02() = work.m128_f32[2] + to.M02();
		to.M11() = A.M01() * A.M01() + A.M11() * A.M11() + to.M11();
	...
	inline void AddATAToUpper(const AlignedMatrix3f &A, SymmetricMatrix3f &to,  ENFT_SSE::__m128 &work)
	{
		work =  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(A.M00()), A.M_00_01_02_x()),  ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(A.M10()), A.M_10_11_12_x())), 
	...
	template<typename TYPE> inline void AddATAToUpper(const Matrix3<TYPE> &A, SymmetricMatrix3<TYPE> &to)
	{
	...
	template<class MATRIX> inline void FinishAdditionATAToUpper(SymmetricMatrix3f &to) {}
	template<class MATRIX> inline void FinishAdditionATAToUpper(SymmetricMatrix3d &to) {}
	template<class MATRIX_1, class MATRIX_2> inline void FinishAdditionATAToUpper(SymmetricMatrix3f &to) {}
	template<class MATRIX_1, class MATRIX_2> inline void FinishAdditionATAToUpper(SymmetricMatrix3d &to) {}

	template<typename TYPE> inline void SetLowerFromUpper(SymmetricMatrix3<TYPE> &M) {}
	template<typename TYPE> inline void GetDiagonal(const SymmetricMatrix3<TYPE> &M, Vector3<TYPE> &d) { M.GetDiagonal(d); }
	template<typename TYPE> inline void SetDiagonal(const Vector3<TYPE> &d, SymmetricMatrix3<TYPE> &M) { M.SetDiagonal(d); }
	template<typename TYPE> inline void ScaleDiagonal(const float &lambda, SymmetricMatrix3<TYPE> &M) { M.ScaleDiagonal(lambda); }
	template<typename TYPE> inline void IncreaseDiagonal(const float &lambda, SymmetricMatrix3<TYPE> &M) { M.IncreaseDiagonal(lambda); }

	template<typename TYPE> inline void AB(const SymmetricMatrix3<TYPE> &A, const Vector3<TYPE> &B, Vector3<TYPE> &AB)
	{
		AB.v0() = A.M00() * B.v0() + A.M01() * B.v1() + A.M02() * B.v2();
		AB.v1() = A.M10() * B.v0() + A.M11() * B.v1() + A.M12() * B.v2();
		AB.v2() = A.M20() * B.v0() + A.M21() * B.v1() + A.M22() * B.v2();
	}
	template<typename TYPE> inline void AddABTo(const SymmetricMatrix3<TYPE> &A, const Vector3<TYPE> &B, Vector3<TYPE> &to)
	{
		to.v0() = A.M00() * B.v0() + A.M01() * B.v1() + A.M02() * B.v2() + to.v0();
		to.v1() = A.M10() * B.v0() + A.M11() * B.v1() + A.M12() * B.v2() + to.v1();
		to.v2() = A.M20() * B.v0() + A.M21() * B.v1() + A.M22() * B.v2() + to.v2();
	}
	template<typename TYPE> inline void ATB(const SymmetricMatrix3<TYPE> &A, const Vector3<TYPE> &B, Vector3<TYPE> &AB)
	{
	...
	inline bool InvertSymmetricUpper(SymmetricMatrix3f &M)
	{
		...
		const float t = 1 / det, m00 = M.M00(), m01 = M.M01(), m02 = M.M02(), m11 = M.M11();
	...
	inline bool InvertSymmetricUpper(const SymmetricMatrix3f &M, SymmetricMatrix3f &Minv)
	{
		const float det = M.Determinant();
		if(fabs(det) < FLT_EPSILON)
		{
	...
	inline bool InvertSymmetricUpper(const AlignedMatrix3f &M, SymmetricMatrix3f &Minv)
	{
		const float det = M.Determinant();
		if(fabs(det) < FLT_EPSILON)
		{
	...
	template<typename TYPE> inline void ATB(const SymmetricMatrix3<TYPE> &A, const Matrix3<TYPE> &B, Matrix3<TYPE> &ATB)
	{
	...
	template<typename TYPE> inline void SubtractATBFrom(const Matrix3<TYPE> &A, const Matrix3<TYPE> &B, SymmetricMatrix3<TYPE> &from)
	{
	...
	template<typename TYPE> inline void ssTA(const Vector3<TYPE> &s, SymmetricMatrix3<TYPE> &A)
	{
		A.M00() *= s.v0() * s.v0();
		A.M01() *= s.v0() * s.v1();
		A.M02() *= s.v0() * s.v2();
	...
	inline void AB(const AlignedMatrix2x3f &A, const SymmetricMatrix3f &B, AlignedMatrix2x3f &AB,  ENFT_SSE::__m128 *work3)
	{
