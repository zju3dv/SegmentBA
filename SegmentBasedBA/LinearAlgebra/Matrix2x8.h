...
namespace LA
{
	...
	inline void AddAij2To(const AlignedMatrix2x8f &A, AlignedVector8f &to)
	{
		...
		to.v4567() =  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps(A.M_04_05_06_07(), A.M_04_05_06_07()),  ENFT_SSE::_mm_mul_ps(A.M_14_15_16_17(), A.M_14_15_16_17())), to.v4567());
	}
	inline void AddAij2To(const AlignedMatrix2x8f &A, AlignedVector8f &to,  ENFT_SSE::__m128 *work0) { AddAij2To(A, to); }
	inline void sA(const AlignedVector8f &s, AlignedMatrix2x8f &A)
	{
		A.M_00_01_02_03() =  ENFT_SSE::_mm_mul_ps(s.v0123(), A.M_00_01_02_03());	A.M_04_05_06_07() =  ENFT_SSE::_mm_mul_ps(s.v4567(), A.M_04_05_06_07());
		A.M_10_11_12_13() =  ENFT_SSE::_mm_mul_ps(s.v0123(), A.M_10_11_12_13());	A.M_14_15_16_17() =  ENFT_SSE::_mm_mul_ps(s.v4567(), A.M_14_15_16_17());
	}
	...
	inline void AB(const AlignedMatrix2x8f &A, const AlignedVector8f &B, Vector2f &AB,  ENFT_SSE::__m128 *work0) { LA::AB(A, B, AB); }
	inline void ABpCD(const AlignedMatrix2x8f &A, const AlignedVector8f &B, const Matrix2x3f &C, const Vector3f &D, Vector2f &ABpCD)
	{
		ABpCD.v0() = ENFT_SSE::SSE::Sum0123( ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps(A.M_00_01_02_03(), B.v0123()),  ENFT_SSE::_mm_mul_ps(A.M_04_05_06_07(), B.v4567()))) + C.M00() * D.v0() + C.M01() * D.v1() + C.M02() * D.v2();
		ABpCD.v1() = ENFT_SSE::SSE::Sum0123( ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps(A.M_10_11_12_13(), B.v0123()),  ENFT_SSE::_mm_mul_ps(A.M_14_15_16_17(), B.v4567()))) + C.M10() * D.v0() + C.M11() * D.v1() + C.M12() * D.v2();
	}
	inline void ABpCD(const AlignedMatrix2x8f &A, const AlignedVector8f &B, const Matrix2x3f &C, const Vector3f &D, Vector2f &ABpCD,  ENFT_SSE::__m128 *work0) { LA::ABpCD(A, B, C, D, ABpCD); }
