...
namespace LA
{
	...
	public:
		...
		inline const  ENFT_SSE::__m128& M_00_01_02_x() const { return m_00_01_02_x; }			inline  ENFT_SSE::__m128& M_00_01_02_x() { return m_00_01_02_x; }
		inline const  ENFT_SSE::__m128& M_10_11_12_x() const { return m_10_11_12_x; }			inline  ENFT_SSE::__m128& M_10_11_12_x() { return m_10_11_12_x; }
	...
	{
		to.v012x() =  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps(A.M_00_01_02_x(), A.M_00_01_02_x()),  ENFT_SSE::_mm_mul_ps(A.M_10_11_12_x(), A.M_10_11_12_x())), to.v012x());
	}
	...
	{
		to.v012x() =  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps(A.M_00_01_02_x(),  ENFT_SSE::_mm_set1_ps(B.v0())),  ENFT_SSE::_mm_mul_ps(A.M_10_11_12_x(),  ENFT_SSE::_mm_set1_ps(B.v1()))), to.v012x());
	}
	inline void AddATBTo(const AlignedMatrix2x3f &A, const Vector2f &B, Vector3f &to,  ENFT_SSE::__m128 &work)
	{
		work =  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps(A.M_00_01_02_x(),  ENFT_SSE::_mm_set1_ps(B.v0())),  ENFT_SSE::_mm_mul_ps(A.M_10_11_12_x(),  ENFT_SSE::_mm_set1_ps(B.v1())));
		to.v0() = work.m128_f32[0] + to.v0();
		to.v1() = work.m128_f32[1] + to.v1();
		to.v2() = work.m128_f32[2] + to.v2();
	}
	...
	{
		to.M_00_01_02_x() =  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(A.M00()), B.M_00_01_02_x()),  ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(A.M10()), B.M_10_11_12_x())), to.M_00_01_02_x());
		to.M_10_11_12_x() =  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(A.M01()), B.M_00_01_02_x()),  ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(A.M11()), B.M_10_11_12_x())), to.M_10_11_12_x());
	}
	...
	{
		work1[0] =  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps(A.M_00_01_02_x(),  ENFT_SSE::_mm_set1_ps(B.v0())),  ENFT_SSE::_mm_mul_ps(A.M_10_11_12_x(),  ENFT_SSE::_mm_set1_ps(B.v1())));
