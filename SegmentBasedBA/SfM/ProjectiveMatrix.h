...
public:
	...
	{
		M_20_21_22_23() =  ENFT_SSE::_mm_set1_ps(f);
	...
	{
		M_00_01_02_03() =  ENFT_SSE::_mm_mul_ps(sx,  ENFT_SSE::_mm_sub_ps(M_00_01_02_03(),  ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(cx.x()), M_20_21_22_23())));
		M03() = sX.m128_f32[0] * (M03() + ENFT_SSE::SSE::Sum012( ENFT_SSE::_mm_mul_ps(M_00_01_02_03(), cX.XYZx())));
		M_10_11_12_13() =  ENFT_SSE::_mm_mul_ps(sx,  ENFT_SSE::_mm_sub_ps(M_10_11_12_13(),  ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(cx.y()), M_20_21_22_23())));
	...
	inline void Denormalize(const Point3D &cX, const  ENFT_SSE::__m128 &sX, const Point2D &cx, const  ENFT_SSE::__m128 &sx,  ENFT_SSE::__m128 *work2)
	{
		...
		work2[1] =  ENFT_SSE::_mm_set1_ps(1 / sx.m128_f32[0]);
		M_00_01_02_03() =  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps(work2[0], work2[1]),  ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(cx.x()), M_20_21_22_23()));
		...
		M_10_11_12_13() =  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps(work2[0], work2[1]),  ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(cx.y()), M_20_21_22_23()));
	}
