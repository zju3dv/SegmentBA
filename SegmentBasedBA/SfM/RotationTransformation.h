...
public:
	...
	inline void Invert(RotationTransformation2D &Rinv) const { Rinv.m_00_01_10_11 =  ENFT_SSE::_mm_setr_ps(r00(), r10(), r01(), r11()); }
...
public:
	...
	{
		work2[0] =  ENFT_SSE::_mm_mul_ps(R12.r_00_01_10_11(),  ENFT_SSE::_mm_setr_ps(R1.r00(), R1.r10(), R1.r00(), R1.r10()));
		work2[1] =  ENFT_SSE::_mm_mul_ps(R12.r_00_01_10_11(),  ENFT_SSE::_mm_setr_ps(R1.r01(), R1.r11(), R1.r01(), R1.r11()));
...
public:
	...
	{
		X.XYZx() =  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps(r_00_01_02_x(),  ENFT_SSE::_mm_set1_ps(RX.X())), 
										  ENFT_SSE::_mm_mul_ps(r_10_11_12_x(),  ENFT_SSE::_mm_set1_ps(RX.Y()))), 
										  ENFT_SSE::_mm_mul_ps(r_20_21_22_x(),  ENFT_SSE::_mm_set1_ps(RX.Z())));
		X.reserve() = 1;
	}
	inline void ApplyInversely(const Point2D &RX, Point3D &X) const
	{
		X.XYZx() =  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps(r_00_01_02_x(),  ENFT_SSE::_mm_set1_ps(RX.x())), 
										  ENFT_SSE::_mm_mul_ps(r_10_11_12_x(),  ENFT_SSE::_mm_set1_ps(RX.y()))), r_20_21_22_x());
		X.reserve() = 1;
	}
	inline void ApplyInversely(Point3D &X) const
	{
		X.XYZx() =  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps(r_00_01_02_x(),  ENFT_SSE::_mm_set1_ps(X.X())), 
										  ENFT_SSE::_mm_mul_ps(r_10_11_12_x(),  ENFT_SSE::_mm_set1_ps(X.Y()))), 
										  ENFT_SSE::_mm_mul_ps(r_20_21_22_x(),  ENFT_SSE::_mm_set1_ps(X.Z())));
		X.reserve() = 1;
	}
	...
	{
		work4[0] =  ENFT_SSE::_mm_setr_ps(P.M00(), P.M01(), P.M02(), 0.0f);
		work4[1] =  ENFT_SSE::_mm_setr_ps(P.M10(), P.M11(), P.M12(), 0.0f);
		work4[2] =  ENFT_SSE::_mm_setr_ps(P.M20(), P.M21(), P.M22(), 0.0f);
...
#endif
		work =  ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(q.m128_f32[0] + q.m128_f32[0]), q);
		r11() = r22() = 1 - work.m128_f32[0];
		r01() = r10() = work.m128_f32[1];
		r02() = r20() = work.m128_f32[2];
		r12() = work.m128_f32[3];
		r21() = -work.m128_f32[3];
		work =  ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(q.m128_f32[1] + q.m128_f32[1]), q);
