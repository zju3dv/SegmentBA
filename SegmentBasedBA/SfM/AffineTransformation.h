...
public:
	...
	{
		T2.M_00_01_02_x() =  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(T12.M00()), T1.M_00_01_02_x()),  ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(T12.M01()), T1.M_10_11_12_x()));
		T2.M_10_11_12_x() =  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(T12.M10()), T1.M_00_01_02_x()),  ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(T12.M11()), T1.M_10_11_12_x()));
		T2.M02() += T12.M02();
		T2.M12() += T12.M12();
	}
	static inline void AccumulateTransformation(const AffineTransformation2D &T1, const SimilarityTransformation2D &T12, AffineTransformation2D &T2,  ENFT_SSE::__m128 *work1)
	{
		...
		T2.M_00_01_02_x() =  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(work1[0].m128_f32[0]), T1.M_00_01_02_x()),  ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(work1[0].m128_f32[1]), T1.M_10_11_12_x()));
		T2.M_10_11_12_x() =  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(work1[0].m128_f32[2]), T1.M_00_01_02_x()),  ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(work1[0].m128_f32[3]), T1.M_10_11_12_x()));
		T2.M02() += T12.tx();
		T2.M12() += T12.ty();
	}
	...
	{
		work1[0] =  ENFT_SSE::_mm_set1_ps(s);
	...
	static inline bool Invert(const LA::AlignedMatrix2x3f &T, LA::AlignedMatrix2x3f &Tinv)
	{
		if((Tinv.M00() = T.M00() * T.M11() - T.M01() * T.M10()) == 0.0f)
			return false;
		Tinv.M_00_01_02_x() =  ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(1 / Tinv.M00()),  ENFT_SSE::_mm_setr_ps(T.M11(), -T.M01(), -T.M10(), T.M00()));
		Tinv.M10() = Tinv.M02();
