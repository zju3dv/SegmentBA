...
public:
	...
	inline void Denormalize(const  ENFT_SSE::__m128 &mean_u1v1u2v2, const float &scale1, const float &scale2,  ENFT_SSE::__m128 *work3)
	{
		...
		assert(!IsAffineTransformation());
#endif
		work3[0] =  ENFT_SSE::_mm_set_ps(mean_u1v1u2v2.m128_f32[1] * scale1, mean_u1v1u2v2.m128_f32[0] * scale1, scale1, scale1);
		work3[1] =  ENFT_SSE::_mm_set1_ps(1 / scale2);
		work3[2] =  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps(work3[1], M_00_01_02_x()),  ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(mean_u1v1u2v2.m128_f32[2]), M_20_21_22_x()));
		M_00_01_02_x() =  ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_movelh_ps(work3[2], work3[2]), work3[0]);
		M02() = work3[2].m128_f32[2] - (M02() + reserve0());

		work3[2] =  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps(work3[1], M_10_11_12_x()),  ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(mean_u1v1u2v2.m128_f32[3]), M_20_21_22_x()));
		M_10_11_12_x() =  ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_movelh_ps(work3[2], work3[2]), work3[0]);
		M12() = work3[2].m128_f32[2] - (M12() + reserve1());

		work3[2].m128_f32[2] = M22();
		M_20_21_22_x() =  ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_movelh_ps(M_20_21_22_x(), M_20_21_22_x()), work3[0]);
	...
	inline void Normalize(const  ENFT_SSE::__m128 &mean_u1v1u2v2, const float &scale1, const float &scale2,  ENFT_SSE::__m128 *work5)
	{
		...
		assert(!IsAffineTransformation());
#endif
		work5[0] =  ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_movelh_ps( ENFT_SSE::_mm_set1_ps(-scale1),  ENFT_SSE::_mm_set1_ps(-scale2)), mean_u1v1u2v2);
	...
	inline void GetSSE( ENFT_SSE::__m128 *H) const
	{
		...
		assert(!IsAffineTransformation());
#endif
		H[0] =  ENFT_SSE::_mm_set1_ps(M00());		H[1] =  ENFT_SSE::_mm_set1_ps(M01());		H[2] =  ENFT_SSE::_mm_set1_ps(M02());
		H[3] =  ENFT_SSE::_mm_set1_ps(M10());		H[4] =  ENFT_SSE::_mm_set1_ps(M11());		H[5] =  ENFT_SSE::_mm_set1_ps(M12());
		H[6] =  ENFT_SSE::_mm_set1_ps(M20());		H[7] =  ENFT_SSE::_mm_set1_ps(M21());		H[8] =  ENFT_SSE::_mm_set1_ps(M22());
	}
	...
	{
		work2[0] =  ENFT_SSE::_mm_div_ps( ENFT_SSE::_mm_set1_ps(1),  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps(H[6], u1),  ENFT_SSE::_mm_mul_ps(H[7], v1)), H[8]));
		work2[1] =  ENFT_SSE::_mm_sub_ps( ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps(H[3], u1),  ENFT_SSE::_mm_mul_ps(H[4], v1)), H[5]), work2[0]), v2);
		work2[0] =  ENFT_SSE::_mm_sub_ps( ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps(H[0], u1),  ENFT_SSE::_mm_mul_ps(H[1], v1)), H[2]), work2[0]), u2);
	...
	{
		dot =  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps(H[0], u1),  ENFT_SSE::_mm_mul_ps(H[1], v1)), H[2]), u2), 
									 ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps(H[3], u1),  ENFT_SSE::_mm_mul_ps(H[4], v1)), H[5]), v2)), 
											    ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps(H[6], u1),  ENFT_SSE::_mm_mul_ps(H[7], v1)), H[8]));
	}
	...
	static inline void AccumulateTransformation(const SimilarityTransformation2D &H1, const Homography &H12, Homography &H2,  ENFT_SSE::__m128 *work2)
	{
		...
		work2[0] =  ENFT_SSE::_mm_setr_ps(work2[1].m128_f32[0], work2[1].m128_f32[1], H1.tx(), H12.M02());
		work2[1] =  ENFT_SSE::_mm_setr_ps(work2[1].m128_f32[2], work2[1].m128_f32[3], H1.ty(), H12.M12());
		H2.M_00_01_02_x() =  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(H12.M00()), work2[0]),  ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(H12.M01()), work2[1]));
		H2.M02() += work2[0].m128_f32[3];
		H2.M_10_11_12_x() =  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(H12.M10()), work2[0]),  ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(H12.M11()), work2[1]));
		H2.M12() += work2[1].m128_f32[3];
		work2[0].m128_f32[3] = H12.M22();
		H2.M_20_21_22_x() =  ENFT_SSE::_mm_add_ps( ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(H12.M20()), work2[0]),  ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(H12.M21()), work2[1]));
	...
	static bool Invert(const SimilarityTransformation2D &T, Homography &Tinv)
	{
		...
		Tinv.M_10_11_12_x() =  ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(Tinv.reserve0()), T.r_00_01_10_11());
