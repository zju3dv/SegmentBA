...
public:
										  ...
										  ENFT_SSE::__m128 *work4) const
	{
		...
		ZcH.M_00_01_02_x() =  ENFT_SSE::_mm_sub_ps(r_00_01_02_x(),  ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(x.x()), r_20_21_22_x()));
		ZcH.M_10_11_12_x() =  ENFT_SSE::_mm_sub_ps(r_10_11_12_x(),  ENFT_SSE::_mm_mul_ps( ENFT_SSE::_mm_set1_ps(x.y()), r_20_21_22_x()));

		work4[0] =  ENFT_SSE::_mm_setr_ps(PX.M00(), PX.M01(), PX.M02(), 0.0f);
		work4[1] =  ENFT_SSE::_mm_setr_ps(PX.M10(), PX.M11(), PX.M12(), 0.0f);
		work4[2] =  ENFT_SSE::_mm_setr_ps(PX.M20(), PX.M21(), PX.M22(), 0.0f);
											   ...
											   LA::Vector2f &Zc2,  ENFT_SSE::__m128 &e2,  ENFT_SSE::__m128 &work)
	{
		...
		e2 =  ENFT_SSE::_mm_setr_ps(x0.x() - e2.m128_f32[0], x0.y() - e2.m128_f32[1], x1.x() - e2.m128_f32[2], x1.y() - e2.m128_f32[3]);
	}
